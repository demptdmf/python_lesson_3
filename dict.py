...
'''Кроме того, словарные сборки могут быть использованы 
для создания словарей из произвольных выражений ключей и значений:'''
...
'''Когда цикл проходит по словарям, ключ и связанное значение 
могут быть извлечены одновременно с помощью метода items().'''
...
print(dict, '— выведено автоматически по алфавиту')
print()
