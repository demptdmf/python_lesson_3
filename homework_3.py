...
# ---- ВОПРОС ----
# подсмотрел у одного студента в комментариях это решение, т.к. остальные были с импортом разным и т.д.
# Как оно читается. Вариант 2 хочется понять преимущественно, т.к. этот код более короткий с одним правильным циклом
